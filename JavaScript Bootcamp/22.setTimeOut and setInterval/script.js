...
// debugger
const timer1 = setTimeout('console.log("Hii-1")',1000) //1000 mili-second == 1sec// ye functionality hame browser pradaan krta hai ye javascript means ECMA Script me mention Nah hai AUR setTimeout ek (Higher order function hai) but ye ek Asynchronous code v hai matlb ye memory me kahi jaakar save hota h pahle phir (print== run) hota hai. agr  //  
